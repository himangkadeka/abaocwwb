...
<body>
    <div class="d-flex" id="wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 p-5 table-responsive">                      
                        <h4>OFFICE</h4>
                        <div  class ="add-butt p-3 "><a  href="javascript:void(0);" data-toggle="modal" data-target="#officeadd-modal"><button type="button" class="btn btn-primary b-btn" id="addoffice">ADD<i class="fa fa-plus pl-2" aria-hidden="true"></i></button></a></div>
                        <table id="office-table" class="table table-bordered text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$officeinfo->office_id}}</td>
                                    <td>{{$officeinfo->district_name}}</td>
                                    <td>{{$officeinfo->office_name}}</td>
                                    <td>{{$officeinfo->created_on}}</td>
        ...
        <div class="modal fade" id="officeadd-modal">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="#" method="post" enctype = "multipart/form-data" class="w-sm-100 w-auto mx-auto">
                            ...
                            <div class="form-group w-100">
                                <label for="district-name">Select District*</label>
                                <select class="form-control" id="district-name" name="district-name" required>
                                    <option  value="">--Select District--</option>
                                    @foreach($alldistrictinfo as $districtinfo)
                                        <option value="{{$districtinfo->district_code}}">{{$districtinfo->district_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group w-100">
                                <label for="office-name">Office Name*:</label>
                                <input type="text" class="form-control" id="office-name" name="officename" placeholder="Enter Office Name" value="{{ old('officename') }}" required>
                            </div>
                            <div class="d-flex justify-content-center py-4">
								<button type="button" id="officeaddbutt" class="btn btn-primary b-btn">ADD</button>
							</div>
                        </form>
                    </div>
                </div>
