...
<body>
    <div class="d-flex" id="wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 p-5 table-responsive">                      
                        ...
                        <div  class ="add-butt p-3"><a  href="javascript:void(0);" data-toggle="modal" data-target="#maritalstatusadd-modal"><button type="button" class="btn btn-primary b-btn" id="addmaritalstatus">ADD<i class="fa fa-plus pl-2" aria-hidden="true"></i></button></a></div>
                        <table id="maritalstatus-table" class="table table-bordered text-nowrap">
                            ...
                            <tbody>
                                @foreach($allmaritalstatusinfo as $maritalstatusinfo)
                                <tr>
                                    <td>{{$loop->iteration}}</td>
                                    <td>{{$maritalstatusinfo->marital_code}}</td>
                                    <td>{{$maritalstatusinfo->marital_status}}</td>
                                    <td>{{$maritalstatusinfo->created_on}}</td>
        ...
        <div class="modal fade" id="maritalstatusadd-modal">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div id="maritalstatusmsg"></div>
                        <form action="#"  method="post" enctype = "multipart/form-data" class="w-sm-100 w-auto mx-auto">
                            @csrf
                            <div class="form-group w-100">
                                <label for="maritalstatus-code">Marital Status Code*:</label>
                                <input type="text" class="form-control" id="maritalstatus-code" name="maritalstatuscode" placeholder="Enter Marital Status code" value="{{ old('maritalstatuscode') }}" required>
                            </div>
                            <div class="form-group w-100">
                                <label for="marital-status">Marital Status*:</label>
                                <input type="text" class="form-control" id="marital-status" name="maritalstatus" placeholder="Enter Marital Status" value="{{ old('maritalstatus') }}" required>
                            </div>
                            <div class="d-flex justify-content-center py-4">
								        <button type="button" id="maritalstatusaddbutt" class="btn btn-primary b-btn">ADD</button>
							</div>
                        </form>
                    </div>
                </div>
