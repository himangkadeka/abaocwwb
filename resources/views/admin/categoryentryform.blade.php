...
<body>
    <div class="d-flex" id="wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 p-5 table-responsive">                      
                        <h4>CATEGORY</h4>
                        <div  class ="add-butt p-3"><a  href="javascript:void(0);" data-toggle="modal" data-target="#categoryadd-modal"><button type="button" class="btn btn-primary b-btn" id="addcategory">ADD<i class="fa fa-plus pl-2" aria-hidden="true"></i></button></a></div>
                        <table id="category-table" class="table table-bordered text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$categoryinfo->category_code}}</td>
                                    <td>{{$categoryinfo->category_name}}</td>
                                    <td>{{$categoryinfo->created_on}}</td>
        ...
        <div class="modal fade" id="categoryadd-modal">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="#"  method="post" enctype = "multipart/form-data" class="w-sm-100 w-auto mx-auto">
                            ...
                            <div class="form-group w-100">
                                ...
                                <input type="text" class="form-control" id="cat-code" name="categorycode" placeholder="Enter Category code" value="{{ old('categorycode') }}" required>
                            </div>
                            <div class="form-group w-100">
                                <label for="category-name">Branch Name*:</label>
                                <input type="text" class="form-control" id="category-name" name="categoryname" placeholder="Enter Category Name" value="{{ old('categoryname') }}" required>
                            </div>
                            <div class="d-flex justify-content-center py-4">
								        <button type="button" id="categoryaddbutt" class="btn btn-primary b-btn">ADD</button>
							</div>
                        </form>
                    </div>
                </div>
