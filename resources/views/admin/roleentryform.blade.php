...
<body>
    <div class="d-flex" id="wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 p-5 table-responsive">                      
                        <h4>Role</h4>
                        <div  class ="add-butt p-3 "><a  href="javascript:void(0);" data-toggle="modal" data-target="#roleadd-modal"><button type="button" class="btn btn-primary b-btn" id="addrole">ADD<i class="fa fa-plus pl-2" aria-hidden="true"></i></button></a></div>
                        <table id="role-table" class="table table-bordered text-nowrap">
        ...
        <div class="modal fade" id="roleadd-modal">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="#" method="post" enctype = "multipart/form-data" class="w-sm-100 w-auto mx-auto">
                            ...
                            <div class="form-group w-100">
                                ...
                                <input type="text" class="form-control" id="role-name" name="rolename" placeholder="Enter Role" value="{{ old('rolename') }}" required>
                            </div>
                            <div class="d-flex justify-content-center py-4">
								<button type="button" id="roleaddbutt" class="btn btn-primary b-btn">ADD</button>
							</div>
                        </form>
                    </div>
                </div>
