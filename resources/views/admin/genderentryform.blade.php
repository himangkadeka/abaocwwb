...
<body>
    <div class="d-flex" id="wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 p-5 table-responsive">                      
                        <h4>GENDER</h4>
                        <div  class ="add-butt p-3"><a  href="javascript:void(0);" data-toggle="modal" data-target="#genderadd-modal"><button type="button" class="btn btn-primary b-btn" id="addgender">ADD<i class="fa fa-plus pl-2" aria-hidden="true"></i></button></a></div>
                        <table id="gender-table" class="table table-bordered text-nowrap">
                            ...
                            <tbody>
                                @foreach($allgenderinfo as $genderinfo)
                                <tr>
                                    <td>{{$loop->iteration}}</td>
                                    <td>{{$genderinfo->gender_code}}</td>
                                    <td>{{$genderinfo->gender_name}}</td>
                                    <td>{{$genderinfo->created_on}}</td>
        ...
        <div class="modal fade" id="genderadd-modal">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="#"  method="post" enctype = "multipart/form-data" class="w-sm-100 w-auto mx-auto">
                            ...
                            <div class="form-group w-100">
                                <label for="gen-code">Gender Code*:</label>
                                <input type="text" class="form-control" id="gen-code" name="gendercode" placeholder="Enter Gender code" value="{{ old('gendercode') }}" required>
                            </div>
                            <div class="form-group w-100">
                                <label for="gen-name">Gender*:</label>
                                <input type="text" class="form-control" id="gen-name" name="gendername" placeholder="Enter Gender" value="{{ old('gendername') }}" required>
                            </div>
                            <div class="d-flex justify-content-center py-4">
								        <button type="button" id="genderaddbutt" class="btn btn-primary b-btn">ADD</button>
							</div>
                        </form>
                    </div>
                </div>
