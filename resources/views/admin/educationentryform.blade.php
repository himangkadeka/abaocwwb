...
<body>
    <div class="d-flex" id="wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 p-5 table-responsive">                      
                        <h4>EDUCATION</h4>
                        <div  class ="add-butt p-3"><a  href="javascript:void(0);" data-toggle="modal" data-target="#educationadd-modal"><button type="button" class="btn btn-primary b-btn" id="addeducation">ADD<i class="fa fa-plus pl-2" aria-hidden="true"></i></button></a></div>
                        <table id="education-table" class="table table-bordered text-nowrap">
                            ...
                            <tbody>
                                @foreach($alleducationinfo as $educationinfo)
                                <tr>
                                    <td>{{$loop->iteration}}</td>
                                    <td>{{$educationinfo->education_code}}</td>
                                    <td>{{$educationinfo->education_name}}</td>
                                    <td>{{$educationinfo->created_on}}</td>
        ...
        <div class="modal fade" id="educationadd-modal">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="#"  method="post" enctype = "multipart/form-data" class="w-sm-100 w-auto mx-auto">
                            ...
                            <div class="form-group w-100">
                                <label for="edu-code">Education Code*:</label>
                                <input type="text" class="form-control" id="edu-code" name="educationcode" placeholder="Enter Education code" value="{{ old('educationcode') }}" required>
                            </div>
                            <div class="form-group w-100">
                                <label for="edu-name">Education Level*:</label>
                                <input type="text" class="form-control" id="edu-name" name="educationname" placeholder="Enter Education Level" value="{{ old('educationname') }}" required>
                            </div>
                            <div class="d-flex justify-content-center py-4">
								        <button type="button" id="educationaddbutt" class="btn btn-primary b-btn">ADD</button>
							</div>
                        </form>
                    </div>
                </div>
